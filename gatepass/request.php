...
<html>
	...
	<nav>
		<div class="nav">
			...
			<div class="link">
				<h1>E-Gate Pass</h1>
				<ul>
					<li><a href="requests.php" ><h3 class="active">Requests</h3></a></li>
	...
	<div class="table">
		<table>
			<tr><th colspan="12">REQUESTES</th></tr>
		...
		$sql = mysqli_query($conn, $query);
			...
			echo "<tr><td>".$row['sno']."</td><td>".$row['studentname']."</td><td>".$row['branch']."</td><td>".$row['roll']."</td><td>".$row['studying']."</td><td>".$row['leaving']."</td><td>".$row['arraival']."</td><td>".$row['place']."</td><td>".$row['phone']."</td><td>".$row['reason']."</td><td><a href='acceptsregister.php?q=".$row['sno']."'target='blank'>accept</a><td><a href='reject.php?q=".$row['sno']."'target='blank'>reject</a></td></tr>";
		?>
