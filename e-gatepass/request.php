  ...
  <table class="table" id="table">
        ...
        <th>Reason</th> <th>Accept</th><th>Reject</th></tr>
            ...
            $sql = mysqli_query($conn, $query);
              ...
              echo "<tr><td>".$row['sno']."</td><td>".$row['oneh/home']."</td><td>".$row['studentname']."</td><td>".$row['branch']."</td><td>".$row['roll']."</td><td>".$row['studying']."</td><td>".$row['leaving']."</td><td>".$row['arraival']."</td><td>".$row['place']."</td><td>".$row['phone']."</td><td>".$row['reason']."</td><td><a href='accepttrans.php?k=".$row['sno']."'><b>Accept</b></a></td><td><a href='rejecttrans.php?m=".$row['sno']."'><b>Reject</b></a></td> </tr>";
            ?>
