...
<div class="table" style="margin-top:30px; ">
	<table text align="center">
		...
		$sql = mysqli_query($conn, $query);
			...
			echo "<tr><td>".$row['sno']."</td><td>".$row['studentname']."</td><td>".$row['branch']."</td><td>".$row['roll']."</td><td>".$row['studying']."</td><td>".$row['leaving']."</td><td>".$row['arraival']."</td><td>".$row['place']."</td><td>".$row['phone']."</td><td>".$row['reason']."</td><td><a href='print.php?q=".$row['sno']."'target='blank'>Print</a></td></tr>";
		?>
	</table>
